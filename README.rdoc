...
A port of Dylan Vaughn's excellent signing gem - https://github.com/stlondemand/aws_cf_signer signing gem.
...
== Installation
  ...
  For this version place a copy of aws_cf_signer in your lib directory.
  Then create an initializer that sets the pem path and optionally overrides defaults.

  e.g. AWS::CloudFront::Signer.configure! mypempath.pem, :expires => Time.now + 3600
