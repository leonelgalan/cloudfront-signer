...
== Installation
  ...
  This gem has been publised as cloudfront-signer. Use gem install cloudfront-signer to install the gem. 
  
  Alternatively, place a copy of cloudfront-signer.rb (and cloundfront-signer sub directory)  in your lib directory.
...
== Usage
  ...
  # Both sign_url and sign_path have 'safe' versions that HTML encode the result allowing 
